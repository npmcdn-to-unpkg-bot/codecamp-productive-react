...
`}
      ...
      <Slide title="React & eco-system solutions">
        ...
        <ul>
          <li>CSSModules - local css
            <ul>
              <li>still css</li>
              <li>autogenerated classnames</li>
            </ul>
          </li>
          <li>
      ...
      <Slide title="React & eco-system solutions">
        ...
        <Snippet style={{fontSize: 30, color: 'black'}}>{`
          export default () => {
            const names = ['React','Ember','Angular'].map(name => <li>{name}!!</li>)
            return <ul>
              {names}
            </ul>
          }
      ...
      <Slide title="React & eco-system solutions">
        <img style={{maxHeight: 230, verticalAlign:'middle'}} src={reduxLogo} />
        <ul>
          <li><b>1</b> way flow!!!</li>
          <li>state updates as pure functions</li>
          <li><Code style={{color:'black'}}>(state) => UI</Code></li>
          <ul>
            <li>app snapshots + undo/redo for free</li>
            <li>timetravel</li>
          </ul>
          <li>immutable data libs are popular</li>
        </ul>
      ...
      <Slide title="React as rendering target">
        <ul>
          <li>for mobile/native for iOS, Android, MS Universal Platform, OSX</li>
          <li>for the DOM with ReactDOM</li>
          <li>for terminal/text UI - react-blessed</li>
          <li>for canvas/webgl</li>
        </ul>
      </Slide>
      ...
      <Slide title="React revolution">
        <ul>
         ...
         <li>React made is rethink the way we build UIs</li>
